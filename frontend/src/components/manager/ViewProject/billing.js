...
class Landing extends Component {
    ...
    render() {
        ...
        // let subTotal = 0
        let S3costs = this.state.numberOfFiles * 0.15
            ...
            <div>
                ...
                <div className="m-5 p-5 shadow">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-2"><h2>${S3costs}</h2></div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-2"><h2>${deviceFarmCosts}</h2></div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-2"><h2>${emulatorCosts}</h2></div>
                    </div>
                    ...
                    <div className="row bg-secondary p-2 text-white">
                        ...
                        <div className="col-md-2"><h2>${subTotal}</h2></div>
                    </div>
